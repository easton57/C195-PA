...
public class CustomerActionsController {
    ...
    protected void onSaveButtonClick(ActionEvent event) {
        ...
        Customer newCustomer = new Customer(Integer.parseInt(customerIdInput.getText()), customerNameInput.getText(),
                addressInput.getText(), postalCodeInput.getText(), phoneNumberInput.getText(), Integer.parseInt(divisionNames.get(divisionIdBox.getValue())));
